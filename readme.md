...
**Requires Python 3.10+.** Application Default Credentials, per-thread subcollections, sync and async, subgraphs. Conformance-tested with `langgraph-checkpoint-conformance` (full base suite).
